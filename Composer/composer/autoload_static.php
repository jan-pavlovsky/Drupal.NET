...
class ComposerStaticInitDrupal8
{
    ...
    public static $prefixDirsPsr4 = array (
        ...
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Core/Composer',
        ),
        'Drupal\\Core\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Core',
        ),
        'Drupal\\Component\\Uuid\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/Uuid',
        ),
        'Drupal\\Component\\Utility\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/Utility',
        ),
        'Drupal\\Component\\Transliteration\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/Transliteration',
        ),
        'Drupal\\Component\\Serialization\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/Serialization',
        ),
        'Drupal\\Component\\Render\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/Render',
        ),
        'Drupal\\Component\\ProxyBuilder\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/ProxyBuilder',
        ),
        'Drupal\\Component\\Plugin\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/Plugin',
        ),
        'Drupal\\Component\\PhpStorage\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/PhpStorage',
        ),
        'Drupal\\Component\\HttpFoundation\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/HttpFoundation',
        ),
        'Drupal\\Component\\Graph\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/Graph',
        ),
        'Drupal\\Component\\Gettext\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/Gettext',
        ),
        'Drupal\\Component\\FileSystem\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/FileSystem',
        ),
        'Drupal\\Component\\FileCache\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/FileCache',
        ),
        'Drupal\\Component\\EventDispatcher\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/EventDispatcher',
        ),
        'Drupal\\Component\\Discovery\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/Discovery',
        ),
        'Drupal\\Component\\Diff\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/Diff',
        ),
        'Drupal\\Component\\DependencyInjection\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/DependencyInjection',
        ),
        'Drupal\\Component\\Datetime\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/Datetime',
        ),
        'Drupal\\Component\\ClassFinder\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/ClassFinder',
        ),
        'Drupal\\Component\\Bridge\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/Bridge',
        ),
        'Drupal\\Component\\Assertion\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/Assertion',
        ),
        'Drupal\\Component\\Annotation\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/Annotation',
        ),
        'Drupal\\Component\\' => 
        array (
            0 => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component',
        ),
    ...
    public static $classMap = array (
        ...
        'Drupal' => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal.php',
        'Drupal\\Component\\Utility\\Timer' => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/Utility/Timer.php',
        'Drupal\\Component\\Utility\\Unicode' => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Component/Utility/Unicode.php',
        'Drupal\\Core\\Database\\Database' => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Core/Database/Database.php',
        'Drupal\\Core\\DrupalKernel' => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Core/DrupalKernel.php',
        'Drupal\\Core\\DrupalKernelInterface' => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Core/DrupalKernelInterface.php',
        'Drupal\\Core\\Site\\Settings' => substr(__DIR__, 0, strlen(__DIR__) - 9)  . '/core/lib/Drupal/Core/Site/Settings.php',
